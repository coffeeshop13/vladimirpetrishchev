...
.post-grid { border-top:1px solid var(--ink); margin-top:100px; } .post-card { border-bottom:1px solid var(--line); grid-template-columns:15% 32% 29% 24%; gap:20px; padding:26px 0; display:grid; transition:background .2s; } .post-card:hover { background:#eeece5; } .post-card time,.post-meta { color:#6a7077; padding-top:5px; font-family:DM Mono,monospace; font-size:11px; } .post-card h2 { letter-spacing:-.04em; margin:0 0 8px; font-family:Fraunces,serif; font-size:29px; font-weight:500; line-height:1.12; } .post-card p { color:#515963; max-width:340px; margin:2px 0; font-size:14px; line-height:1.5; } .post-card-media { align-self:center; } .post-card-media img { border:1px solid var(--line); display:block; height:116px; object-fit:cover; object-position:center; width:100%; } .tags { color:var(--blue); font-family:DM Mono,monospace; font-size:11px; padding-top:5px; }
